...
public class L2AttackableAI extends L2CharacterAI implements Runnable
{
	...
	private void thinkAttack()
	{
		...
		if (originalAttackTarget == null || originalAttackTarget.isAlikeDead() || (originalAttackTarget instanceof L2PcInstance && (!((L2PcInstance) originalAttackTarget).isOnline())) || attackTimeout < GameTimeController.getGameTicks())
		{
