...
public class VanHalter extends Quest implements Runnable
{
	...
	private static final String SELECT_VAN_HALTER_ROYAL_GUARD_SPAWNS = "SELECT id, count, npc_templateid, locx, locy, locz, heading, respawn_delay FROM vanhalter_spawnlist WHERE npc_templateid BETWEEN ? AND ? ORDER BY id";
	private static final String SELECT_VAN_HALTER_TRIOL_REVELATION_SPAWNS = "SELECT id, count, npc_templateid, locx, locy, locz, heading, respawn_delay FROM vanhalter_spawnlist WHERE npc_templateid BETWEEN ? AND ? ORDER BY id";
	private static final String SELECT_VAN_HALTER_ROYAL_GUARD_CAPTAIN_SPAWNS = "SELECT id, count, npc_templateid, locx, locy, locz, heading, respawn_delay FROM vanhalter_spawnlist WHERE npc_templateid = ? ORDER BY id";
	private static final String SELECT_VAN_HALTER_ROYAL_GUARD_HELPER_SPAWNS = "SELECT id, count, npc_templateid, locx, locy, locz, heading, respawn_delay FROM vanhalter_spawnlist WHERE npc_templateid = ? ORDER BY id";
	private static final String SELECT_VAN_HALTER_GUARD_OF_ALTAR_SPAWNS = "SELECT id, count, npc_templateid, locx, locy, locz, heading, respawn_delay FROM vanhalter_spawnlist WHERE npc_templateid = ? ORDER BY id";
	private static final String SELECT_VAN_HALTER_SPAWN = "SELECT id, count, npc_templateid, locx, locy, locz, heading, respawn_delay FROM vanhalter_spawnlist WHERE npc_templateid = ? ORDER BY id";
	private static final String SELECT_VAN_HALTER_RITUAL_OFFERING_SPAWN = "SELECT id, count, npc_templateid, locx, locy, locz, heading, respawn_delay FROM vanhalter_spawnlist WHERE npc_templateid = ? ORDER BY id";
	private static final String SELECT_VAN_HALTER_RITUAL_SACRIFICE_SPAWN = "SELECT id, count, npc_templateid, locx, locy, locz, heading, respawn_delay FROM vanhalter_spawnlist WHERE npc_templateid = ? ORDER BY id";
	...
	protected void loadRoyalGuard()
	{
		...
		try(Connection con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement = con.prepareStatement(SELECT_VAN_HALTER_ROYAL_GUARD_SPAWNS))
		{
		...
		catch (Exception e)
		{
			...
			LOGGER.error("VanHalterManager.loadRoyalGuard: Spawn could not be initialized", e);
		}
	}
	...
	protected void loadTriolRevelation()
	{
		...
		try(Connection con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement = con.prepareStatement(SELECT_VAN_HALTER_TRIOL_REVELATION_SPAWNS))
		{
	...
	protected void loadRoyalGuardCaptain()
	{
		...
		try(Connection con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement = con.prepareStatement(SELECT_VAN_HALTER_ROYAL_GUARD_CAPTAIN_SPAWNS))
		{
		...
		{
			LOGGER.error("VanHalterManager.loadRoyalGuardCaptain: Spawn could not be initialized", e);
		}
	}
	...
	protected void loadRoyalGuardHelper()
	{
		...
		try(Connection con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement = con.prepareStatement(SELECT_VAN_HALTER_ROYAL_GUARD_HELPER_SPAWNS))
		{
		...
		{
			LOGGER.error("VanHalterManager.loadRoyalGuardHelper: Spawn could not be initialized", e);
		}
	}
	...
	protected void loadGuardOfAltar()
	{
		...
		try(Connection con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement = con.prepareStatement(SELECT_VAN_HALTER_GUARD_OF_ALTAR_SPAWNS))
		{
		...
		{
			LOGGER.error("VanHalterManager.loadGuardOfAltar: Spawn could not be initialized", e);
		}
	}
	...
	protected void loadVanHalter()
	{
		...
		try(Connection con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement = con.prepareStatement(SELECT_VAN_HALTER_SPAWN))
		{
		...
		{
			LOGGER.error("VanHalterManager.loadVanHalter: Spawn could not be initialized", e);
		}
	}
	...
	protected void loadRitualOffering()
	{
		...
		try(Connection con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement = con.prepareStatement(SELECT_VAN_HALTER_RITUAL_OFFERING_SPAWN))
		{
		...
		{
			LOGGER.error("VanHalterManager.loadRitualOffering: Spawn could not be initialized", e);
		}
	}
	...
	protected void loadRitualSacrifice()
	{
		...
		try(Connection con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement = con.prepareStatement(SELECT_VAN_HALTER_RITUAL_SACRIFICE_SPAWN))
		{
		...
		{
			LOGGER.error("VanHalterManager.loadRitualSacrifice: Spawn could not be initialized", e);
		}
	}
