...
public class NpcInfo extends L2GameServerPacket
{
	...
	public NpcInfo(final L2NpcInstance cha, final L2Character attacker)
	{
		...
		title = cha.getTemplate().serverSideTitle ? cha.getTemplate().title : cha.getTitle();
	...
	protected final void writeImpl()
	{
		...
		CharacterHolder ch = ObjectData.get(CharacterHolder.class, activeChar instanceof L2Summon ? ((L2Summon) activeChar).getOwner() : activeChar);
		
		if (ch != null)
		{
			writeC(ch.getTeam().ordinal());
		}
		else
		{
			writeC(0x00);
