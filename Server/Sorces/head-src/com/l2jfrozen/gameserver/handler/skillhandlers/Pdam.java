	...
	public void useSkill(final L2Character activeChar, final L2Skill skill, final L2Object[] targets)
	{
		...
		for (final L2Object target2 : target_s)
		{
			...
			if (damage > 50000 && Config.LOG_HIGH_DAMAGES && activeChar instanceof L2PcInstance)
			{
				...
				L2Log.add(activeChar.getName() + "(" + activeChar.getObjectId() + ") " + activeChar.getLevel() + " lvl did damage " + damage + " with skill " + skill.getName() + "(" + skill.getId() + ") to " + name, "damage_pdam");
			}
