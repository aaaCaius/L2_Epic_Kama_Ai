...
import com.l2jfrozen.gameserver.datatables.LifeStoneTable;
import com.l2jfrozen.gameserver.datatables.ScrollEnchantTable;
...
public class ItemTable
{
	...
	private Item readItem(final ResultSet rset) throws SQLException
	{
		...
		if(Config.SCROLL_ENCHANT_STACKABLE && ScrollEnchantTable.getAllScrollEnchantIds().contains(item.id))
		{
			consume = "stackable";
		}
		
		if(Config.LIFE_STONE_IS_STACKABLE && LifeStoneTable.getAllLifeStonesIds().contains(item.id))
		{
			consume = "stackable";
		}
