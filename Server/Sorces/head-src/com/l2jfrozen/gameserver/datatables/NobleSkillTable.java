...
public class NobleSkillTable
{
	...
	private NobleSkillTable()
	{
		...
		nobleSkills[0] = SkillTable.getInstance().getInfo(325, 1);
		nobleSkills[1] = SkillTable.getInstance().getInfo(326, 1);
		nobleSkills[2] = SkillTable.getInstance().getInfo(327, 1);
		nobleSkills[3] = SkillTable.getInstance().getInfo(1323, 1);
