...
public class Wedding
{
	...
	private static final String SELECT_WEDDING_INFO_BY_ID = "SELECT id, player1Id, player2Id, married, affianceDate, weddingDate, coupleType FROM character_wedding WHERE id=?";
	private static final String INSERT_ENGAGE_COUPLE_DATA = "INSERT INTO character_wedding (id, player1Id, player2Id, married, affianceDate, weddingDate) VALUES (?,?,?,?,?,?)";
	private static final String UPDATE_COUPLE_WEDDING = "UPDATE character_wedding SET married= ?,weddingDate=?, coupleType=? WHERE id=?";
	private static final String DELETE_COUPLE_WEDDING = "DELETE FROM character_wedding WHERE id=?";
	...
	public Wedding(int coupleId)
	{
		...
		{
			LOGGER.error("Wedding.Wedding : Something wrong while getting couple data from character_wedding table. ", e);
		}
	}
	...
	public Wedding(L2PcInstance player1, L2PcInstance player2)
	{
		...
		{
			LOGGER.error("Wedding.Wedding(param,param2) : Can not insert engage couple data into character_wedding table. ", e);
		}
	}
	...
	public void marry(int type)
	{
		...
		{
			LOGGER.error("Wedding.marry : Can not update couple wedding data into character_wedding table. ", e);
		}
	}
	...
	public void divorce()
	{
		...
		{
			LOGGER.error("Wedding.divorce : Can not delete couple wedding data from character_wedding table. ", e);
		}
	}
