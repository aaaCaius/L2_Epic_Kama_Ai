...
public enum ClassId
{
	...
	Shillien_Oracle(0x2a, true, Race.darkelf, Dark_Mystic),
	Shillen_Elder(0x2b, true, Race.darkelf, Shillien_Oracle),
	...
	Shillien_Saint(0x70, true, Race.darkelf, Shillen_Elder),
	...
	private static List<ClassId> classList = new ArrayList<>();
	
	static
	{
		for(ClassId classId : values())
		{
			if(classId.getId() >= 58 && classId.getId() <= 87)
				continue;
	...
	/**
	 * @return Class list without dummy entries
	 */
	public static List<ClassId> getClassList()
	{
		return classList;
	}
}
