@echo off
CHCP 65001
SET title_text=L2JFrozen 1.5 Game Server Console
SET file=../l2jfrozen_15.info
...
:start
java -Dfile.encoding=UTF8 -server -Xms1024m -Xmx1024m -XX:MetaspaceSize=256M -XX:+UseStringDeduplication -cp ./lib/*;l2jfrozen-core.jar com.l2jfrozen.gameserver.GameServer
