...
class Quest (JQuest) :
 ...
 def onTalk (Self,npc,player):
   ...
   if npcId == HIERARCH_ASTERIOS and Race in [Race.elf]:
     if ClassId in [ClassId.Elven_Fighter]: 
       st.setState(STARTED)
       return "30154-01.htm"
     if ClassId in [ClassId.Elven_Mystic]:
       st.setState(STARTED)
       return "30154-02.htm"
     if ClassId in [ClassId.Elven_Wizard, ClassId.Oracle, ClassId.Elven_Knight, ClassId.Elven_Scout]:
