...
class Quest (JQuest) :
 ...
 def onTalk (Self,npc,player):
   ...
   if npcId == HIGH_PRIEST_BIOTIN and Race in [Race.human]:
     if ClassId in [ClassId.Human_Fighter, ClassId.Warrior, ClassId.Knight, ClassId.Rogue]:
       htmltext = "30031-08.htm"
     if ClassId in [ClassId.Warlord, ClassId.Paladin, ClassId.Treasure_Hunter]:
       htmltext = "30031-08.htm"
     if ClassId in [ClassId.Gladiator, ClassId.Dark_Avenger, ClassId.Hawkeye]:
       htmltext = "30031-08.htm"
     if ClassId in [ClassId.Human_Wizard, ClassId.Cleric]:
       htmltext = "30031-06.htm"
     if ClassId in [ClassId.Sorcerer, ClassId.Necromancer, ClassId.Warlock, ClassId.Bishop, ClassId.Prophet]:
