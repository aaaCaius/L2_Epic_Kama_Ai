...
class Quest (JQuest) :
 ...
 def onTalk (Self,npc,player):
   ...
   if npcId == TETRARCH_THIFIELL and Race in [Race.darkelf]:
     if ClassId in [ClassId.Dark_Fighter]: 
       st.setState(STARTED)
       return "30358-01.htm"
     if ClassId in [ClassId.Dark_Mystic]:
       st.setState(STARTED)
       return "30358-02.htm"
     if ClassId in [ClassId.Dark_Wizard, ClassId.Shillien_Oracle, ClassId.Palus_Knight, ClassId.Assassin]:
