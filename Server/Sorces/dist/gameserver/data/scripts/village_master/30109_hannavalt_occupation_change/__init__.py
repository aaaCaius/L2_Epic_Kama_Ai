...
class Quest (JQuest) :
 ...
 def onEvent (self,event,st):
   ...
   if event == "class_change_20":
     if ClassId in [ClassId.Elven_Knight]:
        if Level <= 39:
   ...
   if event == "class_change_23":
     if ClassId in [ClassId.Elven_Scout]:
        if Level <= 39:
 ...
 def onTalk (Self,npc,player):
   ...
   if npcId == GRAND_MASTER_HANNAVALT or GRAND_MASTER_SIRIA or GRAND_MASTER_BLACKBIRD or GRAND_MASTER_SEDRICK or GRAND_MASTER_MARCUS and Race in [Race.elf, Race.human]:
     if ClassId in [ClassId.Elven_Knight]:
       ...
       st.setState(STARTED)
       return "30109-15.htm"
     elif ClassId in [ClassId.Elven_Scout]:
       st.setState(STARTED)
       return "30109-22.htm"
     elif ClassId in [ClassId.Warrior]:
       st.setState(STARTED)
       return "30109-29.htm"
     elif ClassId in [ClassId.Elven_Fighter, ClassId.Human_Fighter]:
       st.setState(COMPLETED)
       st.exitQuest(1)
       return "30109-76.htm"     
     elif ClassId in [ClassId.Temple_Knight, ClassId.Plains_Walker, ClassId.Sword_Singer, ClassId.Silver_Ranger]:
       st.setState(COMPLETED)
       st.exitQuest(1)
       return "30109-77.htm"
     elif ClassId in [ClassId.Warlord, ClassId.Paladin, ClassId.Treasure_Hunter]:
       st.setState(COMPLETED)
       st.exitQuest(1)
       return "30109-77.htm"
     elif ClassId in [ClassId.Gladiator, ClassId.Dark_Avenger, ClassId.Hawkeye]:
       st.setState(COMPLETED)
       st.exitQuest(1)
       return "30109-77.htm"
     else:
